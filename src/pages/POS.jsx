...
//   // Auto‑print receipt logic moved to the dedicated effect below.
...
//         customerReceiptRef.current?.innerHTML;

//       const kitchenReceipt =
//         kitchenReceiptRef.current?.innerHTML;
...
//                   <span>
//                     $
//                     {lastOrder.deliveryCost.toFixed(2)}
//                   </span>
//                 </div>
...
//             <div className="item-row bold big">
//               <span>Total</span>
...
//       vatAmount: vatAmount,
//       // Include delivery details if selected
...
export default function POS() {
  ...
  useEffect(() => {
    ...
    const printReceipts = async () => {
      // Wait for React render cycle to flush DOM changes
      await new Promise(resolve => setTimeout(resolve, 400));
